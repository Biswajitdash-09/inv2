                    ...
                    <AnimatePresence mode="wait">
                        {stage === 'EMAIL' ? (
                            ...
                            >
                                ...
                                {success && (
                                    <div className="bg-green-100/50 text-green-600 text-sm p-3 rounded-xl text-center font-medium">
                                        <p>{success}</p>
                                    </div>
                                )}
                                ...
                                <div className="space-y-1">
                                    <div className="flex justify-between items-center">
                                        <label className="text-sm font-semibold text-gray-900 ml-1">Reset Code</label>
                                        {otpTimer > 0 ? (
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="input w-full pl-11 bg-white/50 border-gray-200 focus:bg-white focus:ring-2 focus:ring-primary/20 rounded-xl transition-all text-gray-900 placeholder:text-gray-500 tracking-widest font-mono"
                                            placeholder="123456"
                                            disabled={isLoading}
                                        />
                                    </div>
                                ...
                                <div className="space-y-1">
                                    <label className="text-sm font-semibold text-gray-900 ml-1">New Password</label>
                                    <div className="relative">
                                ...
                                <button
                                    ...
                                    className="text-xs text-gray-500 hover:text-gray-700 block mx-auto py-1"
                                >
                                    Change Email?
                                </button>
                            </motion.form>
