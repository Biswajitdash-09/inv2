        ...
        try {
            ...
            if (user) {
                ...
                if (role === ROLES.PROJECT_MANAGER) {
                    ...
                    // Finance users ONLY see invoices explicitly assigned to them via hierarchy.
                    // Assignment is auto-resolved from the PM's managedBy on invoice submission.
                    // This enforces the Admin → FU → PM → Vendor hierarchy strictly.
